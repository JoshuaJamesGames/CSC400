...
Create a Display Class that will store a copy of the order queue in 
two arrays. Each array will contain the order list but one will be 
sorted by name and the other sorted by order number. When a order is 
...
quick sort and outputs the the contents to the console upon each entry of 
new data.
...
Class. The user will be presented a menu to add a order, remove a order 
